...
void ALacrCharacterBase::BeginPlay()
{
	...
	ACameraStateManager* CameraStateManager = Cast<ACameraStateManager>(PlayerController->PlayerCameraManager);
...
void ALacrCharacterBase::LockMovementInput(bool bLockMovement) const
{
